...
class PaymentController extends Controller
{
    public function payment()
    {
        ...
        if (Auth::user()->type == 'lawyer') {
            ...
            return view('userpanel.payment-add-card', ['cardnumber' => $cardnumber, 'cardtype' => $cardtype, 'expiremonth' => $expiremonth, 'expireyear' => $expireyear, 'fcard' => $fcardnumber]);
        }
    }
    ...
    public function payment_history(Request $req)
    {
        ...
        if ($usertype == 'lawyer') {
            ...
            return view('userpanel.payment_history_to_admin', ['payments' => $payments]);
        }
    }
