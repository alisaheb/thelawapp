    ...
    <body class="page-container-bg-solid page-header-fixed page-sidebar-closed-hide-logo page-md">
      ...
      @include('admininclude.header')
          ...
          @include('admininclude.sidebar')
                ...
                <div class="page-content">
                    ...
                    <div class="page-head">
                        ...
                        <div class="page-title">
                            <h1>Add New Announcement
                                <small>add new Announcement</small>
                            </h1>
                        </div>
                        <!-- END PAGE TITLE -->
           ...
           <!--                             <span class="caption-subject font-dark sbold uppercase">Advance Validation</span>-->
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('admin/categories')}}/{{$Announcement->id}}" method="POST" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Announcement Icon</label>
                                                <div class="col-md-4">
                                                
                                                @if(empty($Announcement->Announcement_image))
                                                    <span id="profile-pic"><img style="width:100px; height:auto" src="{{url('../Announcement_images/law.jpg')}}"/></span>
                                                   @else
                                                   <span id="profile-pic"><img style="width:100px; height:auto" src="{{url('../Announcement_images')}}/{{$Announcement->Announcement_image}}"/></span>
                                                   @endif
                                           ...
                                           <div class="form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text" name="name" value="{{$Announcement->name}}" data-required="1" class="form-control" /> </div>
                                            </div>
                                            <div class="form-group">
                                                <label class="col-md-3 control-label">Announcement image
                                                    
                                                </label>
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        
                                                        <input type="file" name="image" class="" accept="image/*"> </div>
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="description" rows="4" data-error-container="#editor2_error" >{{$Announcement->description}}</textarea>
        ...
        <div class="page-footer">
            <div class="page-footer-inner"> 2017 &copy; The Law App
            </div>
