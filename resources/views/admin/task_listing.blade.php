                           ...
                           <table class="table table-striped table-bordered table-hover table-checkable " id="sample_1">
                              ...
                              <tbody>
                                 ...
                                 <tr class="odd gradeX">
                                    ...
                                    <td class="center">
                                       {{$task->estimate_budget}}
                                    </td>
                                    <td class="center"> @if($task->status=='unverify') Not Verified @else {{ucfirst($task->status)}} @endif </td>
                                    <td class="center"> {{$task->user['email']}} </td>
                                    <td class="center">   {{$task->created_at->format('Y-M-d')}} </td>
                                    <td>
                                       <div class="btn-group">
                                          ...
                                          <ul class="dropdown-menu" role="menu">
                                             <li>
                                                <a href="{{ url('admin/task/edit') }}/{{$task->id}}">
                                                <i class="icon-docs"></i> Edit </a>
                                             </li>
                                             <li>
                                                <a href="{{ url('admin/task/delete') }}/{{$task->id}}">
                     ...
                     <div class="page-quick-sidebar-item">
                        <div class="page-quick-sidebar-chat-user">
                           <div class="page-quick-sidebar-nav">
                              ...
                              <i class="icon-arrow-left"></i>Bacfk</a>
                           </div>
