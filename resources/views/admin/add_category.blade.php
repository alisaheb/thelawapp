                    ...
                    <div class="row">
                      ...
                      <!--                  <span class="caption-subject font-dark sbold uppercase">Advance Validation</span>-->
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('admin/categories')}}" method="POST" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="description" rows="4" data-error-container="#editor2_error" ></textarea>
