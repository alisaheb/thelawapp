          ...
          @include('admininclude.sidebar')
           ...
           <!--                             <span class="caption-subject font-dark sbold uppercase">Advance Validation</span>-->
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('admin/categories')}}/{{$category->id}}" method="POST" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                @if(empty($category->category_image))
                                                    <span id="profile-pic"><img style="width:100px; height:auto" src="{{url('../category_images/law.jpg')}}"/></span>
                                                   @else
                                                   <span id="profile-pic"><img style="width:100px; height:auto" src="{{url('../category_images')}}/{{$category->category_image}}"/></span>
                                                   @endif
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                             ...
                                             <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="description" rows="4" data-error-container="#editor2_error" >{{$category->description}}</textarea>
