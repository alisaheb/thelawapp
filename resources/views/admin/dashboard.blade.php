                    ...
                    <div class="row widget-row">
                        <div class="col-md-3">
                            ...
                            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                                <h4 class="widget-thumb-heading">Total Lawyers</h4>
                                <div class="widget-thumb-wrap">
                                    <i class="widget-thumb-icon bg-green icon-bulb"></i>
                                    <div class="widget-thumb-body">
                                        <span class="widget-thumb-subtitle">K</span>
                        ...
                        <div class="col-md-3">
                            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                                <h4 class="widget-thumb-heading">Total Clients</h4>
                                <div class="widget-thumb-wrap">
                        ...
                        <div class="col-md-3">
                            <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                                <h4 class="widget-thumb-heading">Total Cases</h4>
                                <div class="widget-thumb-wrap">
                     ...
                     <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject bold uppercase font-dark">Recent Cases on The Lawapp</span>
                                    </div>
                                </div>
                                    ...
                                    @else
                                        <ul>
                                            @foreach($tasks as $task)
                                                <li>
                                                    <p>"{{$task->title}}" - ${{$task->estimate_budget}} By {{$task->user->fname}}
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption ">
                                        <span class="caption-subject font-dark bold uppercase">Recent Comments</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                                    @if($comments->isEmpty())
                                    ...
                                    @else
                                        <ul>
                                            @foreach($comments as $comment)
                                                <li>
                                                    <p>"{{$comment->task->title}}" - {{$comment->comments}} By {{$comment->userBy->fname}}
                                                        <font>{{ $comment->created_at->diffForHumans() }}</font></p>
                                                </li>
                                            @endforeach
                                        </ul>
                                    @endif
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <span class="caption-subject bold uppercase font-dark">Cases Stats</span>
                                        <span class="caption-helper">Cases stats...</span>
                                    </div>
                                </div>
                                <div class="portlet-body">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption ">
                                        <span class="caption-subject font-dark bold uppercase">Cases By Region</span>
