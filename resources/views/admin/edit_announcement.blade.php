          ...
          @include('admininclude.sidebar')
           ...
           <!--                             <span class="caption-subject font-dark sbold uppercase">Advance Validation</span>-->
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('admin/announcements')}}/{{$announcement->id}}" method="POST" id="form_sample_3" class="form-horizontal" enctype="multipart/form-data">
                                        {{csrf_field()}}
                                        {{method_field('PUT')}}
                                         <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                <label class="control-label col-md-3">Announcement For
                                                    <span class="required"> * </span>
                                                </label>
                                                <div class="col-md-4" style="display: flex">
                                                    <input type="radio" name="type" required class="form-control" value="1" @if($announcement->type == 1){{'checked'}}@endif />Lawyer 
                                                    <input type="radio" name="type" required class="form-control" value="2" @if($announcement->type == 2){{'checked'}}@endif />Client 
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group last">
                                                <label class="control-label col-md-3">Announcement <span class="required"> * </span></label>
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="announcement" rows="4" data-error-container="#editor2_error" >{{$announcement->announcement}}</textarea>
