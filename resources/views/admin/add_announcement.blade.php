                    ...
                    <div class="row">
                      ...
                      <!--                  <span class="caption-subject font-dark sbold uppercase">Advance Validation</span>-->
                                ...
                                <div class="portlet-body">
                                    <!-- BEGIN FORM-->
                                    <form action="{{url('admin/announcements')}}" method="POST" id="form_sample_3" class="form-horizontal" >
                                        {{csrf_field()}}
                                        <div class="form-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-4" style="display: flex">
                                                    <input type="radio" name="type" required class="form-control" value="1" />Lawyer 
                                                    <input type="radio" name="type" required class="form-control" value="2" />Client 
                                                </div>
                                            </div>
                                             ...
                                             <div class="form-group last">
                                                ...
                                                <div class="col-md-9">
                                                    <textarea class="form-control" name="announcement" rows="4" data-error-container="#editor2_error" ></textarea>
